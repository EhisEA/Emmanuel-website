export function buildContactEmailHtml(name: string, email: string, message: string) {
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
          ...
          <tr>
            <td style="padding-bottom:32px;">
              ...
              <span style="float:right;font-size:12px;color:#9CA3AF;line-height:24px;">New Contact Message</span>
            </td>
          </tr>
          <!-- Card -->
          <tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                <tr>
                  <td style="padding-bottom:4px;">
                    <span style="font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#6366F1;font-weight:600;">From</span>
                  </td>
                </tr>
                <tr>
                  <td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding-bottom:8px;">
                    <span style="font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#6366F1;font-weight:600;">Message</span>
                  </td>
                </tr>
                <tr>
                  <td style="font-size:15px;line-height:1.6;color:#E5E7EB;">
                    ${escapedMessage}
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" style="padding-top:32px;">
              <span style="font-size:12px;color:#9CA3AF;">Sent from your website contact form</span>
            </td>
          </tr>
        </table>
      </td>
